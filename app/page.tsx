    ...
    () => [
      {
        ...
        type: "node",
        position: { x: 0, y: 0 },
        data: { content: introLine, concepts: ["Concept Flow"], degree: 0, depth: 0},
      ...
      },
      {
        ...
        data: { content: problemLine, concepts: ['Problems'], depth: 1},
        dragHandle: ".custom-drag-handle",
      ...
      },
      {
        ...
        type: 'node',
        position: { x: 400, y: 0},
        data: { content: mindMapLine, concepts: ['Mind map'], depth: 1},
        dragHandle: ".custom-drag-handle",
        parentId: ROOT_NODE_ID,
      },
      {
        ...
        data: { content: nodeLine, concepts: ['Nodes'], depth: 2},
        dragHandle: ".custom-drag-handle",
        parentId: 'MindMap',
      },
      {
        ...
        data: { content: begForStarLine, concepts: ['Try it out!'], depth: 2},
        dragHandle: ".custom-drag-handle",
        parentId: 'problems',
      },
      {
        ...
        type: 'node',
        position: { x: 400, y: 100},
        data: { content: ragLine, concepts: ['RAG'], depth: 2},
        dragHandle: ".custom-drag-handle",
        parentId: 'MindMap',
      },
    ],
